...
from services.portfolio_services import view_all_portfolios, delete_portfolio, create_portfolio, liquidate_holdings
...
_router: Dict[str, MenuFunctions] ={
    ...
    "3.4": MenuFunctions(executor=liquidate_holdings, navigator=lambda: constants.portfolio_menu),
